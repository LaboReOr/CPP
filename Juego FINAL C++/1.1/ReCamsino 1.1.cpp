...
void juegoBlackJack(int &coin){
    ...
    while (bucle){
        ...
        cout << R"(
          ...
          |                      2 - Salir                        |
          |                                                       |)" << endl;
        cout << "          |                     saldo: "<< coin << espaciado << "|" << endl;
        cout << "          '-------------------------------------------------------'" << endl;
        cout << "--> ";
        cin >> respuesta;
        cout << RESET;
...
void main_game(int &coins){
    ...
    cout<<"              ReCamsino v1.1 - WASD para moverte"<<endl;
    cout<<endl;
    cout<<endl;
    while(true){
